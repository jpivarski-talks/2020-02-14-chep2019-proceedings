...
For a dataset with $n$ nodes (dozens to hundreds) and $N$ elements in the array (may be billions), the number of reference count checks and virtual method lookups scale with $n$, while the 
