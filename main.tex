...
Based on user response, the old and new versions of Awkward Array will become \mintinline{bash}{awkward0} and \mintinline{bash}{awkward}, respectively, allowing physics analyses that were written with the old Awkward interface to continue unchanged, apart from ``\mintinline{python}{import awkward0 as awkward}'', while future developments focus on the new library.
